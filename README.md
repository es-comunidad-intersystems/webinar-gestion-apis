...
* Prepara lo que necesitamos para la parte práctica siguiendo las secciones [Instalación de IRIS](#instalación-de-iris) e [Instalación de IAM](#instalación-de-iam).
